...
description: "Future token integration points anchored in the manager contract."
---
...
- Indexer: `ModuleSet` / `AuditLog` events are uniform and indexed — extend `coreTopics()` in `backend/internal/indexer/abis.go` when token modules ship.
