...
# Override via env vars for any non-local use.
# See: https://book.getfoundry.sh/reference/anvil#default-accounts
PK_DEPLOY="${ANVIL_PK_DEPLOY:-0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80}"
PK_SELLER="${ANVIL_PK_SELLER:-0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d}"
PK_ALICE="${ANVIL_PK_ALICE:-0x5de4111afa1a4b94908f83103eb1f1706367c2e68ca870fc3fb9a804cdab365a}"
PK_BOB="${ANVIL_PK_BOB:-0x7c852118294e51e653712a81e05800f419141751be58f605c371e15141b007a6}"
PK_KEEPER="${ANVIL_PK_KEEPER:-0xdbda1821b80551c9d65939329250298aa3472ba22feea921c0cf5d620ea67b97}"
PK_CREATOR="${ANVIL_PK_CREATOR:-0x2a871d0798f97d79848a013d4936a73bf4cc922c825d33c1cf7073dff6d409c6}"
SELLER="${ANVIL_SELLER:-0x70997970C51812dc3A010C7d01b50e0d17dc79C8}"
ALICE="${ANVIL_ALICE:-0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC}"
BOB="${ANVIL_BOB:-0x90F79bf6EB2c4f870365E785982E1f101E93b906}"
CREATOR="${ANVIL_CREATOR:-0xa0Ee7A142d267C1f36714E4a8F75612F20a79720}"
