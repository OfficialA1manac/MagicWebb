...
func ComplexityConfig() ComplexityRoot {
	return ComplexityRoot{
		...
		Collection: struct {
			...
			Name:        func(c int) int { return costScalar },
			Standard:    func(c int) int { return costEnum },
			Stats:       func(c int) int { return costObject + c },
		...
		Query: struct {
			...
			Auction:             func(c int, _ int) int { return costListBase + c },
			Auctions:            func(c int, _, _, _ *string, limit *int, _, _ *string) int { return listCost(c, limit) },
			Collection:          func(c int, _ string) int { return costListBase + c },
			CollectionStats:     func(c int, _ string) int { return costObject + c },
			...
			Listing:             func(c int, _, _ string) int { return costListBase + c },
			Listings:            func(c int, _, _, _ *string, limit *int, _, _, _ *string) int { return listCost(c, limit) },
			Metrics:             func(c int) int { return costObject + c },
			...
			Profile:             func(c int, _ string) int { return costObject + c },
			...
			TokenAttributes:     func(c int, _, _ string) int { return costObject + c },
			TokenFullMetadata:   func(c int, _, _ string) int { return costObject + c },
			TokenMeta:           func(c int, _, _ string) int { return costScalar + c },
			TotalVolume24h:      func(c int) int { return costScalar },
			TraitValues:         func(c int, _ string) int { return costObject + c },
