...
type Auction struct {
	...
	Name            string                 `protobuf:"bytes,14,opt,name=name,proto3" json:"name,omitempty"`
	ImageUri        string                 `protobuf:"bytes,15,opt,name=image_uri,json=imageUri,proto3" json:"image_uri,omitempty"`
	// Collection badge: standard NFT contract with resolved metadata (migration 034).
	CollectionVerified bool `protobuf:"varint,16,opt,name=collection_verified,json=collectionVerified,proto3" json:"collection_verified,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *Auction) GetCollectionVerified() bool {
	if x != nil {
		return x.CollectionVerified
	}
	return false
...
const file_marketplace_v1_marketplace_proto_rawDesc = "" +
	...
	"\bauctions\x18\x01 \x03(\v2\x17.marketplace.v1.AuctionR\bauctions\"\x95\x04\n" +
	"\aAuction\x12\x1d\n" +
	"\n" +
	"auction_id\x18\x01 \x01(\x03R\tauctionId\x12\x1e\n" +
	"\n" +
	...
	"\x04name\x18\x0e \x01(\tR\x04name\x12\x1b\n" +
	"\timage_uri\x18\x0f \x01(\tR\bimageUri\x12/\n" +
	"\x13collection_verified\x18\x10 \x01(\bR\x12collectionVerified\"\x7f\n" +
	...
	"\bGetToken\x12\x1f.marketplace.v1.GetTokenRequest\x1a .marketplace.v1.GetTokenResponse\x12W\n" +
	"\x0fListCollections\x12&.marketplace.v1.ListCollectionsRequest\x1a\x1a.marketplace.v1.Collection0\x01\x12\\\n" +
	"\rGetCollection\x12$.marketplace.v1.GetCollectionRequest\x1a%.marketplace.v1.GetCollectionResponse\x12N\n" +
	"\fListListings\x12#.marketplace.v1.ListListingsRequest\x1a\x17.marketplace.v1.Listing0\x01\x12N\n" +
	"\fListAuctions\x12#.marketplace.v1.ListAuctionsRequest\x1a\x17.marketplace.v1.Auction0\x01\x12V\n" +
	"\vGetActivity\x12\".marketplace.v1.GetActivityRequest\x1a#.marketplace.v1.GetActivityResponse\x12H\n" +
	"\n" +
	"ListOffers\x12!.marketplace.v1.ListOffersRequest\x1a\x15.marketplace.v1.Offer0\x01\x12\\\n" +
