...
export function MarketDiscovery() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold md:text-3xl">Discover listings</h2>
        <p className="mt-2 max-w-2xl text-sm text-neutral-400">
          Live ERC-721 listings are read from the Marketplace contract (recent{" "}
          <code className="text-neutral-300">Listed</code> logs + on-chain state). Filter by collection name, symbol,
          or address. Optional <span className="font-mono text-xs">NEXT_PUBLIC_TRACKED_COLLECTIONS</span> adds projects
          that have not listed yet.
        </p>
      </div>
